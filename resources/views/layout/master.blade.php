...
<head>
    ...
    <link href="{{ URL::asset('plugins/forms/uniform/uniform.default.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('plugins/tables/dataTables/jquery.dataTables.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('plugins/tables/dataTables/TableTools.css') }}" rel="stylesheet" type="text/css" />
...
<!-- Table plugins -->
<script type="text/javascript" src="{{ URL::asset('plugins/tables/dataTables/jquery.dataTables.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('plugins/tables/dataTables/TableTools.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('plugins/tables/dataTables/ZeroClipboard.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('plugins/tables/responsive-tables/responsive-tables.js') }}"></script><!-- Make tables responsive -->
<script type="text/javascript" src="{{ URL::asset('js/datatable.js') }}"></script><!-- Init plugins only for page -->

<!-- Misc plugins -->
<script type="text/javascript" src="{{ URL::asset('plugins/misc/nicescroll/jquery.nicescroll.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('plugins/misc/qtip/jquery.qtip.min.js') }}"></script><!-- Custom tooltip plugin -->
<script type="text/javascript" src="{{ URL::asset('plugins/misc/totop/jquery.ui.totop.min.js') }}"></script>
