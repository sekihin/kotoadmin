...
Modernizr.load({
  ...
  nope: 'js/jquery/plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: ['js/jquery/plugins/fix/ios-fix/ios-orientationchange-fix.js', 'js/jquery/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
